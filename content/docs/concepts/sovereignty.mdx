...
1. **Data plane** — [zero egress](/docs/concepts/zero-egress) makes residency physical.
...
Vault customers fetch a measured-boot [attestation report](/docs/api-reference) per rack
